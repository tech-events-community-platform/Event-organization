          ...
          <div className="px-3 py-2 border-b border-[#AA767C]/40 flex items-center justify-between">
            <div className="space-y-0.5 min-w-0">
              <div className="flex items-center gap-1.5">
                ...
                <ShieldCheck className="w-3.5 h-3.5 text-[#FFA686] shrink-0" />
              </div>
              <p className="text-[10px] text-[#FFA686] font-medium truncate">Verified Attendee Passholder</p>
            </div>
            <button
              type="button"
        ...
        <div className="pt-4 border-t border-[#AA767C]/40">
          <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-2.5 px-1'} min-w-0`}>
            <img
              ...
              alt="Attendee"
              title={isCollapsed ? user?.name || 'Attendee' : undefined}
